...
export default function RegistrationForm({ idPrefix = 'form' }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 5. Production: ask Ezsite backend to create a Stripe Checkout Session
      ...
      const { data: stripeData, error: stripeError } = await window.ezsite.apis.createStripeCheckout({
